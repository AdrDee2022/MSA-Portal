...
app.factory('AutocompleteList', function($http, $q, $timeout){
  let AutocompleteList = new Object();

  AutocompleteList.getautocomplete = function(i,list) {
